...
- LangGraph + ReAct workflows with human-in-the-loop interrupts + guardrails
- MCP tool servers wrapping SSH / Kafka / PostgreSQL into a reusable tool layer
- pgvector RAG over runbooks; evaluated retrieval quality (Recall@k / nDCG) + evidence checks
- CI/CD pipelines; published to ACR + deployed on Azure Container Apps
